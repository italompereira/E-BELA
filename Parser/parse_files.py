...
def load_entities():
  path_train = '../LC-QuAD2.0/dataset/train.json'
  path_test = '../LC-QuAD2.0/dataset/test.json'
...
def main():
  ...
  #Parallel(n_jobs=6)(delayed(get_file)(remote_file, path_dir, entities, relations) for remote_file in lines if '#' not in remote_file)
